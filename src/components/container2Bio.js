        ...
        return (
            <div className="container-bio">
                ...
                <div className="bio-item2">
                    ...
                    <p>     Your online presence is your brand. For businesses, the style and performance of your website will have a substantial impact on the number of your customers, their willingness to trade with you, and eventually the profits of your company. For individuals and other organisations, a great well-designed website can help you reach other people faster and make the information about you or your organisation more accessible. Please do not hesitate to contact me if you  have any questions or business enquiries, or if you just want to say hi! ; ) </p>
                </div>
            </div>
        )
    }
